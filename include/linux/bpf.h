	...
	bpf_func_t bpf_func)
{
	 ...
	 * configurable POC offset uses M[k]'s low byte at -20 - 4*k.
	 * Generated by: GPT-5. */
	/* Inject the configured stale byte into the configured cBPF M[k] slot.
	 * The store is architectural; the JIT'd filter then stores 0 to the same
